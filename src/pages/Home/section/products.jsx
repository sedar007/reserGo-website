                ...
                <div className="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
                    ...
                    <FadeInWhenVisible>
                        <div className="group relative">
                            ...
                            <h3 className="mt-6 text-sm text-gray-500">
                                <a href="#"><span className="absolute inset-0" />Séjournez avec confort</a>
                            </h3>
                    ...
                    <FadeInWhenVisible>
                        <div className="group relative">
                            ...
                            />
                            <h3 className="mt-6 text-sm text-gray-500">
                                <a href="#"><span className="absolute inset-0" />Savourez chaque bouchée</a>
                            </h3>
                    ...
                    <FadeInWhenVisible>
                        <div className="group relative">
                            ...
                            />
                            <h3 className="mt-6 text-sm text-gray-500">
                                <a href="#"><span className="absolute inset-0" />Célébrez vos moments forts</a>
                            </h3>
